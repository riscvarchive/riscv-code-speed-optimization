...
  - Leave one month for volunteers. Can start today though.
...
  - An VPS/IaaS for hosting the website. PLCT has an existing VPS and can donate it.
* license costs
...
  - After the website and hardware farm are established, roughly one engineer one day (8 hours) per week.
