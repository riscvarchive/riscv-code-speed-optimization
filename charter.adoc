...
This document is a draft for review pending final approval by the SIG membership at its meeting on 19 November 2020.  It will then be submitted for ratification by the Technical Steering Committee.
